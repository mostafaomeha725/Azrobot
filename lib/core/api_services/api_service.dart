...
Future<Either<Failure, SignUpModel>> signUpUser({
  ...
  required String cityId,  // ابقها String
  required String specialtyId,  // ابقها String
  ...
  try {
    final response = await dio.post(
      ...
      data: {
        ...
        "city_id": cityId,  // تأكد أن السيرفر يتوقع string
        "specialty_id": specialtyId,  // تأكد أن السيرفر يتوقع string
      },
      options: Options(
